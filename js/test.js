...
function checkAnswer(indexAnswer, indexQuestion) {
    if (indexAnswer === correctAnswersIndexArray[indexQuestion]) {
        correctAnswersCount++;
    }
}
